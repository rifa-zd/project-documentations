# Academic Project Documentation Hub

Centralized repository yet for all academic project documentation.
...
- [Case Study](./International%20Relation/Case%20Study.pdf) on `Israel-Hamas War: Causes and Consequences`
- [Term Paper](./International%20Relation/Term%20Paper.pdf) on `The Rohingya Crisis and Bangladesh Diplomacy`

### MAT104 - Coordinate Geometry and Vector Analysis
- [Presentation](./Mathematics%20and%20Statistics%20Courses/MAT104%20presentation%20slide.pptx) on `The bisectors of the angles between the lines represented by the general equation of second degree`


### MAT102 - Differential Equations and Special Functions 
- [MATLAB Documentation](./Mathematics%20and%20Statistics%20Courses/MAT102%20Matlab.pd)
- [Presentation](./Mathematics%20and%20Statistics%20Courses/MAT102%20Presentation.pptx) on `Solution Method of Higher Order Homogeneous Linear Differential Equation with Constant Coefficients when roots are not equal`

### MAT101 - Differential and Integral Calculus
- [Presentation](./Mathematics%20and%20Statistics%20Courses/MAT101%20Presentation.pptx) on `Tangent Line`
